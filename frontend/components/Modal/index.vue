<template>
  <div class="bg-black absolute top-0 flex items-center justify-center left-0 bg-opacity-25 w-full h-screen z-50">
    <div ref="modals" class="w-[95vmin] h-2/3 bg-white rounded-md px-3 py-3">
      ...
      <hr class="mt-2">
      <div class="w-full h-[calc(100%-33px)] flex flex-col justify-between overflow-y-auto scrollbar-thin">
        <slot></slot>
